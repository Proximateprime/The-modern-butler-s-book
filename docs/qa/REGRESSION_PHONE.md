...
If **What Butler does** appears (**1 of 3**): **Skip**, or **Next** through **What it doesn’t do** and **Your household stays here** → **Get started**. Then **Safety disclaimer** → **I understand**. Details: [`FIRST_RUN.md`](FIRST_RUN.md).
