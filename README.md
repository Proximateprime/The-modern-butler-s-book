...
Play Store listing is out. This tree is **0.1.4+10** first-run tap (whole screen advances; Skip still 48px; I understand is not skippable) — no App Bundle upload and no Console listing. Live tester APK/Pages stay **0.1.4+5** until a later publish.
